...
import org.tomaximo.finddetabash.DomeinnNoAtai;
import org.tomaximo.finddetabash.FindTheField;
import org.tomaximo.finddetabash.ListApurikeshonnKannkei;
import org.tomaximo.kks.ImpKksGui;



public class AllToMaximoPuroguramubak01 extends JFrame{
	...
	public AllToMaximoPuroguramubak01() throws BadLocationException {
    	this(true);
	}
	public AllToMaximoPuroguramubak01(boolean windowclose){
		...
		comboBox = new JComboBox();comboBox.setToolTipText("配置名称");
	...
	public static void main(String ages[]) throws BadLocationException, IOException{
		AllToMaximoPuroguramubak01 amp=new AllToMaximoPuroguramubak01();
		amp.readSetting();
		amp.callJcomboBox();
	}
...
//		comboBox.setSelectedItem(defuorutomeishou);
		comboBox.setSelectedItem("localhost");

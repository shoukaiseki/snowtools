package org.tomaximo.puroguramu.tuuyou;
...
public class IconSigenn {
	...
	public final static ImageIcon CLEAR=new ImageIcon(ICONS_PATH+"oracle/javatools/icons/clear.png");

	/**
	 * 文件图标
	 */
	public final static ImageIcon OPEN=new ImageIcon(ICONS_PATH+"oracle/javatools/icons/open.png");
	 ...
	 * APP应用
	 */
	public final static ImageIcon APPLICATION=new ImageIcon(ICONS_PATH+"oracle/javatools/icons/application.png");
	public final static ImageIcon KOKUMINNTOU=new ImageIcon(ICONS_PATH+"shoukaiseki/kokuminntou.png");

...
public class JTableOperating线程会死锁_bak extends JTable {
	/**
	 * 表格模型对象
	 */
	...
	public JTableOperating线程会死锁_bak(int arg0, int arg1) {
		super(arg0, arg1);
		initDefuoruto();
		columnCount = this.getColumnCount();
	}

	public JTableOperating线程会死锁_bak(TableModel dm) {
...
//		System.out.println("Runnable--threadAddRow->" + "end");
	...
	public static void main(String[] args) {
		...
		JTableOperating线程会死锁_bak table = null;
		// table = new JTableOperating(50, 18);

		Object rows[][] = {};
		String columns[] = { "姓名", "国籍", "年龄" };
		table = new JTableOperating线程会死锁_bak(new DefaultTableModel(columns, 55));
...
//		ExcelAdapter myAd = new ExcelAdapter(table);
		...
		for (int i = 0; i < 99; i++) {
			final JTableOperating线程会死锁_bak table1 = table;

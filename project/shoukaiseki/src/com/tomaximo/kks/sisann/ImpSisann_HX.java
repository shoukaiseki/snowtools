...
//	private String orgid="'CRPXZ'";
	...
	public ImpSisann_HX() throws DocumentException, SQLException {
...
//		osd = rdc.getOracleSqlDatabese("crpnr","ImpSisann");//70
	...
	public void exec() throws SQLException{
		...
		osdExec.setTableRoot("SHOUKAISEKI_INSERT_SISANN_HX");
		osdExec.setWhere(" column23 is not null AND not exists(select * from asset where asset.assetnum=SHOUKAISEKI_INSERT_SISANN_HX.column23 and siteid="+siteid+")");

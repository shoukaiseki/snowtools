package com.tomaximo.kks.sisann;
...
public class ImpSisannFenlei_bak01 {
...
//	public String superAssetId="1012";//資產總分類id
	public String superAssetId="1020";//資產總分類id
	...
	public ImpSisannFenlei_bak01() throws DocumentException, SQLException {
		logger.level=7;
...
//		osd = rdc.getOracleSqlDatabese("阜陽測試庫","ImpSisann");
		osd = rdc.getOracleSqlDatabese("阜陽測試庫maximo_75","ImpSisann");
		osd.setLevel(7);
		osd.testReadData(7);
...
//		System.out.println(classStructureuId);
	...
	public long  insertAll(String ownerId, String owner02, String ownernum,
		...
		if(strss[0][0]==null){
			if(strss[1][0]==null){
				...
				psClassAncestor.setString(osdClassAncestor.getInsertColumnIndex("CLASSIFICATIONID"), classIficationDescription);
	...
	public static void main(String[] args) throws DocumentException, SQLException {
		ImpSisannFenlei_bak01 impSIsann = new ImpSisannFenlei_bak01();

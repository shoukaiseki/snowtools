package com.tomaximo.puroguramu.plugins;
...
import com.shoukaiseki.gui.jbutton.JButtonIcon;
...
import com.shoukaiseki.gui.jtree.IconJTreeObject;
...
import com.shoukaiseki.gui.tabbedpane.ClosableTabbedPane;
import com.shoukaiseki.gui.tabbedpane.ClosableTabbedPaneRisuna;
...
import com.tomaximo.puroguramu.ijframe.PrintJyouhou;
import com.tomaximo.puroguramu.ijframe.SennyouNoMaximoJnf;
import com.tomaximo.puroguramu.interfaces.DetabesuKonnfiguAppInterFace;
...
public class AddKyoka extends SennyouNoMaximoJnf 
implements DetabesuKonnfiguAppInterFace{
	...
	public AddKyoka(String string,SennyouNoMaximo sennyouNoMaximo,ConnectionKonnfigu ck) {
		super();
	...
	public void init(){ 
		super.init();
		addApurikeshonn("添加至权限组",IconSigenn.RUN);
		addRisuna();
	}
